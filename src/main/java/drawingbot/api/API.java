...
public class API {
    ...
    public interface IDrawingBotAPI {
         ...
         */
        <C> void createBooleanSetting(Class<C> pfmClass, String settingName, Boolean defaultValue, BiConsumer<C, Boolean> setter);
         ...
         * @param setter function which applies the setting to the {@link IPathFindingModule}
         */
        <C> void createStringSetting(Class<C> pfmClass, String settingName, String defaultValue, BiConsumer<C, String> setter);
         ...
         * @param setter function which applies the setting to the {@link IPathFindingModule}
         */
        <C> void createRangedFloatSetting(Class<C> pfmClass, String settingName, float defaultValue, float minValue, float maxValue, BiConsumer<C, Float> setter);
         ...
         * @param setter function which applies the setting to the {@link IPathFindingModule}
         */
        <C> void createRangedLongSetting(Class<C> pfmClass, String settingName, long defaultValue, long minValue, long maxValue, BiConsumer<C, Long> setter);
         ...
         * @param setter function which applies the setting to the {@link IPathFindingModule}
         */
        <C> void createRangedIntSetting(Class<C> pfmClass, String settingName, int defaultValue, int minValue, int maxValue, BiConsumer<C, Integer> setter);
    }
