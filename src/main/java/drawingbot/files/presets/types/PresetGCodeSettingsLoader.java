...
public class PresetGCodeSettingsLoader extends AbstractSettingsLoader<PresetGCodeSettings> {
    ...
    public void registerSettings(){
        ...
        registerSetting(GenericSetting.createOptionSetting(DrawingBotV3.class, "gcodeUnits", List.of(UnitsLength.values()), UnitsLength.MILLIMETRES, (app, value) -> app.gcodeUnits.set(value)).setGetter(app -> app.gcodeUnits.get()));
        ...
        registerSetting(GenericSetting.createOptionSetting(DrawingBotV3.class, "gcodeCommentType", List.of(GCodeBuilder.CommentType.values()), GCodeBuilder.CommentType.BRACKETS, (app, value) -> app.gcodeCommentType.set(value)).setGetter(app -> app.gcodeCommentType.get()));
