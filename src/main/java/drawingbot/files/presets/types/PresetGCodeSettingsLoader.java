...
public class PresetGCodeSettingsLoader extends AbstractSettingsLoader<PresetGCodeSettings> {
    ...
    public void registerSettings(){
        ...
        registerSetting(GenericSetting.createStringSetting(DrawingBotV3.class, "gcodeStartCode", GCodeExporter.defaultStartCode, false, (app, value) -> app.gcodeStartCode.set(value)).setGetter(app -> app.gcodeStartCode.get()));
        registerSetting(GenericSetting.createStringSetting(DrawingBotV3.class, "gcodeEndCode", GCodeExporter.defaultEndCode, false, (app, value) -> app.gcodeEndCode.set(value)).setGetter(app -> app.gcodeEndCode.get()));
        registerSetting(GenericSetting.createStringSetting(DrawingBotV3.class, "gcodePenDownCode", GCodeExporter.defaultPenDownCode, false, (app, value) -> app.gcodePenDownCode.set(value)).setGetter(app -> app.gcodePenDownCode.get()));
        registerSetting(GenericSetting.createStringSetting(DrawingBotV3.class, "gcodePenUpCode", GCodeExporter.defaultPenUpCode, false, (app, value) -> app.gcodePenUpCode.set(value)).setGetter(app -> app.gcodePenUpCode.get()));
        registerSetting(GenericSetting.createStringSetting(DrawingBotV3.class, "gcodeStartLayerCode", GCodeExporter.defaultStartLayerCode, false, (app, value) -> app.gcodeStartLayerCode.set(value)).setGetter(app -> app.gcodeStartLayerCode.get()));
        registerSetting(GenericSetting.createStringSetting(DrawingBotV3.class, "gcodeEndLayerCode", GCodeExporter.defaultEndLayerCode, false, (app, value) -> app.gcodeEndLayerCode.set(value)).setGetter(app -> app.gcodeEndLayerCode.get()));
    }
