...
public class PixelDataARGB4D extends PixelDataARGB {
    ...
    public void setChannel(int channel, int x, int y, int value) {
        ...
        onChangedRGB(x, y, alpha.getData(x, y), red.getData(x, y), green.getData(x, y), blue.getData(x, y));
    }
    ...
    protected void onChangedRGB(int x, int y, int a, int r, int g, int b){
    ...
    @Override //// overriding an unused method to avoid changes to IPixelData
    public void setHue(int x , int y, int target) { 
        //super.setTransparentARGB(argb);
