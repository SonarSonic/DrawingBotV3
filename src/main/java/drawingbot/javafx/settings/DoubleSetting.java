...
public class DoubleSetting<C> extends RangedNumberSetting<C, Double> {
    ...
    public DoubleSetting(Class<C> pfmClass, String settingName, double defaultValue, double minValue, double maxValue, boolean shouldLock, BiConsumer<C, Double> setter){
